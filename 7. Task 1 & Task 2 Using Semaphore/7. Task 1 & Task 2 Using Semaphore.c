/* I have created two task Task1 & Task2. Task1 is giving signal to Task2, then task2
 * access resource(), we have used semaphore for the same so that synchronization
 * will be there between both tasks*/
