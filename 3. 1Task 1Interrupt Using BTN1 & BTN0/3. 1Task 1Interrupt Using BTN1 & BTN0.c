/* I have created one task Task1 & Task2 is an interrupt task so whenever you press BTN1 or BTN0 it will toggle another LED*/
...
static void prvSetupHardware( void )
{
	...
	/* Install buttons ISR */
	INT_SYS_InstallHandler(BTN_PORT_IRQn, &Task2, NULL);
